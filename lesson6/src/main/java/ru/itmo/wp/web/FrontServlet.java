...
public class FrontServlet extends HttpServlet {
    ...
    private void process(Route route,
        ...
        Method methodBef = getMethod("before", pageClass);
        Method method = getMethod(route.getAction(), pageClass);
        Method methodAft = getMethod("after", pageClass);
        ...
        try {
            methodBef.invoke(page, request, view);
            method.invoke(page, request, view);
            methodAft.invoke(page, request, view);
    ...
    private Method getMethod(String name, Class<?> pageClass) throws NotFoundException {
        Method method = null;
